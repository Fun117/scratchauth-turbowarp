...
const config: Config = {
  ...
  tagline: "Scratch Auth",

  // URL to the favicon
  favicon: "/favicon.ico",

  // Production URL of the site
  url: "https://scratchauth-turbowarp.vercel.app",
  ...
  projectName: "scratchauth-turbowarp", // GitHub repository name
  ...
  themeConfig: {
    ...
    metadata: {
      ...
      publisher: "Vercel",
      robots: "follow, index",
      metadataBase: new URL("https://scratchauth-turbowarp.vercel.app"),
    },
